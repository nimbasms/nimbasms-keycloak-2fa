package nimbasms.keycloak.authenticator;
...
public class SmsAuthenticatorFactory implements AuthenticatorFactory {
	...
	public String getDisplayType() {
		return "Nimba SMS Authentication";
	}

	@Override
	public String getHelpText() {
		return "Validates an OTP sent via SMS to the users mobile phone via Nimba SMS.";
	}
	...
	public List<ProviderConfigProperty> getConfigProperties() {
		return List.of(
				new ProviderConfigProperty(SmsConstants.CODE_LENGTH, "Code length",
						"The number of digits of the generated code.", ProviderConfigProperty.STRING_TYPE, 4),
				new ProviderConfigProperty(SmsConstants.CODE_TTL, "Time-to-live",
						...
						"300"),
				new ProviderConfigProperty(SmsConstants.SENDER_ID, "Sender Name",
						"The sender ID is displayed as the message sender on the receiving device.",
						ProviderConfigProperty.STRING_TYPE, "SMS 9080"),
				new ProviderConfigProperty(SmsConstants.SERVICE_ID, "Service Id",
						"Unique identifier to identify your client application.",
						ProviderConfigProperty.STRING_TYPE, ""),
				new ProviderConfigProperty(SmsConstants.SECRET_TOKEN, "Secret Token",
